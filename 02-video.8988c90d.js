 ...
 */var G={role:"viewer",autoPlayMuted:!0,allowedDrift:.3,maxAllowedDrift:1,minCheckInterval:.1,maxRateAdjustment:.2,maxTimeToCatchUp:1},H=/*#__PURE__*/function(e){!function(e,t){if("function"!=typeof t&&null!==t)throw TypeError("Super expression must either be null or a function");e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,writable:!0,configurable:!0}}),Object.defineProperty(e,"prototype",{writable:!1}),t&&g(e,t)}(a,e);var t,n,r,o,i=(t=b(),function(){var e,n=m(a);if(t){var r=m(this).constructor;e=Reflect.construct(n,arguments,r)}else e=n.apply(this,arguments);return function(e,t){if(t&&("object"==typeof t||"function"==typeof t))return t;if(void 0!==t)throw TypeError("Derived constructors may only return object or undefined");return E(e)}(this,e)});/**
   ...
   */function a(e,t){var n,r,o=arguments.length>2&&void 0!==arguments[2]?arguments[2]:{},u=arguments.length>3?arguments[3]:void 0;return h(this,a),y(E(r=i.call(this)),"logger",void 0),y(E(r),"speedAdjustment",0),/**
     ...
     * @return {Promise<void>}
     */function(e,t){return new Promise(function(n){!function r(){e.readyState===t?n():e.addEventListener("readystatechange",r,{once:!0})}()})}}]),a}(/*#__PURE__*/k(EventTarget)),Y=new WeakMap,$=new WeakMap,B={},J=/*#__PURE__*/function(){var e;/**
   * Create a Player.
   *
 ...
 * _.toNumber('3.2');
 * // => 3.2
 */function ed(e){if("number"==typeof e)return e;if("symbol"==typeof(t=e)||t&&"object"==typeof t&&"[object Symbol]"==eu.call(t))return K;if(ef(e)){var t,n="function"==typeof e.valueOf?e.valueOf():e;e=ef(n)?n+"":n}if("string"!=typeof e)return 0===e?e:+e;e=e.replace(Z,"");var r=et.test(e);return r||en.test(e)?er(e.slice(2),r?2:8):ee.test(e)?K:+e}Q=/**
...
u=setTimeout(v,t),h(c))}return void 0===u&&(u=setTimeout(v,t)),a}return t=ed(t)||0,ef(n)&&(s=!!n.leading,i=(f="maxWait"in n)?ec(ed(n.maxWait)||0,t):i,d="trailing"in n?!!n.trailing:d),m.cancel=function(){void 0!==u&&clearTimeout(u),l=0,r=c=o=u=void 0},m.flush=function(){return void 0===u?a:y(es())},m}(e,t,{leading:r,maxWait:t,trailing:o})};const eh=document.querySelector("#vimeo-player"),ep=new J(eh,{id:236203659,width:640});// Добавление обработчика события play
ep.on("play",function(e){let t=e.seconds;// Сохранение текущего времени воспроизведения в локальное хранилище
localStorage.setItem("videoplayer-current-time",JSON.stringify(t))});// Восстановление времени воспроизведения при загрузке страницы
...
const ev=JSON.parse(localStorage.getItem("videoplayer-current-time"));ev&&ep.setCurrentTime(ev).catch(function(e){ep.setCurrentTime(ev||0)}),document.getElementById("current-time"),ep.on("timeupdate",((a=Q)&&a.__esModule?a.default:a)(function(e){let t=e.seconds;console.log("Current playback time:",t),// Сохранение времени воспроизведения в локальное хранилище
localStorage.setItem("videoplayer-current-time",JSON.stringify(t))},1e3)),// Очистка локального хранилища при обновлении времени воспроизведения
...
eh.addEventListener("input",function(){localStorage.clear()});//# sourceMappingURL=02-video.8988c90d.js.map

//# sourceMappingURL=02-video.8988c90d.js.map
