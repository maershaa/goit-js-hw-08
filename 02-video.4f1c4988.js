...
let ev=JSON.parse(localStorage.getItem("videoplayer-current-time"));ep.setCurrentTime(ev||0),document.getElementById("current-time"),ep.on("timeupdate",((a=Q)&&a.__esModule?a.default:a)(function(e){let t=e.seconds;console.log("Current playback time:",t),// Сохранение времени воспроизведения в локальное хранилище
...
eh.addEventListener("input",function(){localStorage.clear()})}();//# sourceMappingURL=02-video.4f1c4988.js.map

//# sourceMappingURL=02-video.4f1c4988.js.map
